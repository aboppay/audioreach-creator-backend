...
export interface TkvParameterUpdateItem {
  tkvSystemId: string;
  parameterSystemIds: string[];
}

export class AddTkvParametersCommand extends BaseCommand {
  ...
  constructor(spfModuleSystemId: string, updates: TkvParameterUpdateItem[]) {
    super();
